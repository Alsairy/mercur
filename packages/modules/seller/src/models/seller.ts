...
export const Seller = model.define("seller", {
  ...
  education_license_number: model.text().nullable(),
  school_type: model.enum(['private', 'international', 'public']).nullable(),
  education_level: model.enum(['elementary', 'middle', 'high', 'university']).nullable(),
  service_categories: model.json().nullable(),
